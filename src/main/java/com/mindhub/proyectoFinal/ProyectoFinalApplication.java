...
public class ProyectoFinalApplication {
	...
	@Bean
	public CommandLineRunner initData(RepositorioCliente repositorioCliente, RepositorioCancha repositorioCancha, RepositorioReserva repositorioReserva, RepositorioCamiseta repositorioCamiseta, RepositorioBotin repositorioBotin, RepositorioMedias repositorioMedias){
		return (args) -> {
