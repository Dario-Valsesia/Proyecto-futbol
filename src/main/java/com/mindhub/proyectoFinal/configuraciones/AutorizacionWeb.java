...
public class AutorizacionWeb extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/mail").hasAnyAuthority("CLIENTE", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/consulta").hasAnyAuthority("CLIENTE", "ADMIN")
                .antMatchers(HttpMethod.POST, "/api/enviar-contraseña").hasAnyAuthority("CLIENTE", "ADMIN")
                .antMatchers(HttpMethod.GET, "/api/productos").hasAnyAuthority("CLIENTE", "ADMIN")
                .antMatchers(HttpMethod.GET, "/api/comprar/producto").hasAnyAuthority("CLIENTE", "ADMIN")
